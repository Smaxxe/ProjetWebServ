    ...
    <div class="top-bar">
      <div class="top-bar-left">
        <ul class="menu nav nav-pills">
          ...
          <li class="nav-item" name="seriesLink">
            <router-link to="/series">Series</router-link>
          </li>
          <li class="nav-item" name="contactLink">
...
export default {
  ...
  mounted() {
    ...
    this.pills["admin"] = document.getElementsByName("adminLink")[0];
  ...
  watch: {
    $route(to) {
      ...
      // on modifie la classe de la pill pour qu'elle devienne surlignée en bleu
      else if (to.path.startsWith("/series"))
        // pour les cas /series et /series/:id
        this.pills["series"].className += " active";
      else if (to.path == "/contact")
        this.pills["contact"].className += " active";
      else if (to.path.startsWith("/admin/series"))
        this.pills["admin"].className += " active";
    },
  },
};
</script>
